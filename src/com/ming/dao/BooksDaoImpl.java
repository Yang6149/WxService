...
public class BooksDaoImpl implements BooksDao{
    ...
    private boolean CreateBooks(Books book) throws SQLException {
        ...
        String sql = "INSERT INTO book(BOOK_ID, BOOK_NAME, USER_ID, BOOK_ISBN, BOOK_AUTHOR" +
        ...
        this.preparedStatement.setDate(8, new Date(book.getBookPtime().getTime()) );
        ...
        this.preparedStatement.setDate(21, new Date(book.getBookUpTime().getTime()));
